...
;// CONCATENATED MODULE: ./src/store/actions/types.ts
var ActionType = {
...
var ActionCreator = {
    updatePosts: function (posts) { return ({
        type: ActionType.UPDATE_POSTS,
        payload: posts,
    }); },
    updateSearchedPosts: function (searchedPosts) { return ({
        type: ActionType.UPDATE_SEARCHED_POSTS,
        payload: searchedPosts,
    }); },
    updatePagesCount: function (pagesCount) { return ({
        type: ActionType.UPDATE_PAGES_COUNT,
        payload: pagesCount,
    }); },
    changeAppStatus: function (appStatus) { return ({
        type: ActionType.CHANGE_APP_STATUS,
        payload: appStatus,
    }); },
};

;// CONCATENATED MODULE: ./src/store/consts.ts
var VIEW_COUNT = 10;
var AppStatus = {
    LOADING: "LOADING",
    ERROR: "ERROR",
...
;// CONCATENATED MODULE: ./src/components/table/header/Search.tsx
...
var searchedPosts = null;
var Search = function () {
    var _a = (0,react.useState)(""), searchQuery = _a[0], setSearchQuery = _a[1];
    var navigate = dist_useNavigate();
    var posts = useSelector_useSelector(function (state) { return state.data.posts; });
    var dispatch = useDispatch();
    (0,react.useEffect)(function () {
        var timeoutId = setTimeout(function () {
            // обновляем данные с задержкой
            if (!searchQuery) {
                // проверяем есть ли содержимое в инпуте
    ...
    var searchPosts = function () {
        searchedPosts = posts.filter(function (post) {
            // создаем массив прошедших проверку постов
            var query = new RegExp("".concat(searchQuery), "i");
    ...
    return (react.createElement("div", { className: "search" },
        react.createElement("input", { className: "search__input", type: "text", placeholder: "\u041F\u043E\u0438\u0441\u043A", value: searchQuery, onChange: function (evt) { return setSearchQuery(evt.target.value); } })));
};
/* harmony default export */ const header_Search = (Search);

;// CONCATENATED MODULE: ./src/components/table/pagination/Pagination.tsx
...
var Pagination = function () {
    ...
    var pagesCount = useSelector_useSelector(function (state) { return state.view.pagesCount; });
    var paginationButtons = Array(pagesCount).fill(""); // создаем массив длиной, соответствующей количеству страниц
    return (react.createElement("div", { className: "pagination" },
        currentPage > 1 ? (react.createElement(NavLink, { to: "/posts/".concat(currentPage - 1), className: "pagination__prev-button" }, "\u041D\u0430\u0437\u0430\u0434")) : (react.createElement("span", { className: "pagination__next-button disabled" }, "\u041D\u0430\u0437\u0430\u0434")),
        react.createElement("div", { className: "pagination__pagination" }, paginationButtons.map(function (el, i) {
            var page = i + 1;
            var isActive = page === currentPage || pagesCount === 0;
            return (react.createElement(NavLink, { to: "/posts/".concat(page), key: i, className: "pagination__pagination-button".concat(isActive ? " active" : "") }, page));
        })),
        currentPage !== pagesCount && pagesCount !== 0 ? (react.createElement(NavLink, { to: "/posts/".concat(currentPage + 1), className: "pagination__next-button" }, "\u0412\u043F\u0435\u0440\u0435\u0434")) : (react.createElement("span", { className: "pagination__next-button disabled" }, "\u0412\u043F\u0435\u0440\u0435\u0434"))));
};
/* harmony default export */ const pagination_Pagination = (Pagination);

;// CONCATENATED MODULE: ./src/components/table/posts/Posts.tsx
...
var Posts = function () {
    var _a = (0,react.useState)(null), sortMode = _a[0], setSortMode = _a[1];
    var page = +useParams().page;
    var navigate = dist_useNavigate();
    var posts = useSelector_useSelector(function (state) { return state.data.posts; });
    var searchedPosts = useSelector_useSelector(function (state) { return state.data.searchedPosts; });
    (0,react.useEffect)(function () {
        setSortMode(null);
    }, [posts, searchedPosts]);
    var sortPosts = function (posts) {
        switch (sortMode) {
            ...
            case SortMode.TITLE:
                return posts.sort(function (a, b) { return (a.title > b.title ? 1 : -1); });
            case SortMode.BODY:
                return posts.sort(function (a, b) { return (a.body > b.body ? 1 : -1); });
            default:
                return posts;
        }
    };
    var onSortButtonClick = function (mode) {
        setSortMode(mode);
        navigate("/posts/1");
    };
    var actualPosts = searchedPosts !== null && searchedPosts !== void 0 ? searchedPosts : posts;
    var displayedPosts = sortPosts(actualPosts.slice()) // дублируем и сортируем массив
        .slice(VIEW_COUNT * page - VIEW_COUNT, VIEW_COUNT * page); // находим нужный кусок массива по текущей странице
    var emptyRowsCount = VIEW_COUNT - displayedPosts.length; // вычисляем, сколько строк таблицы остались не заполнены
    var emptyRows = emptyRowsCount > 0 ? Array(emptyRowsCount).fill(null) : null; // создаем массив с пустыми значениями для незаполненных строк
    return (react.createElement("table", { className: "posts" },
        react.createElement("thead", null,
            react.createElement("tr", { className: "posts__header-row" },
                react.createElement("th", { className: "posts__header posts__header--id" },
                    react.createElement("button", { className: "posts__header-button", onClick: function () { return onSortButtonClick(SortMode.ID); } }, "ID")),
                react.createElement("th", { className: "posts__header posts__header--title" },
                    react.createElement("button", { className: "posts__header-button", onClick: function () { return onSortButtonClick(SortMode.TITLE); } }, "\u0417\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A")),
                react.createElement("th", { className: "posts__header posts__header--description" },
                    react.createElement("button", { className: "posts__header-button", onClick: function () { return onSortButtonClick(SortMode.BODY); } }, "\u041E\u043F\u0438\u0441\u0430\u043D\u0438\u0435")))),
        react.createElement("tbody", null,
            displayedPosts.map(function (post, i) {
                return (react.createElement("tr", { key: i, className: "posts__row" },
                    react.createElement("td", { className: "posts__cell" }, post.id),
                    react.createElement("td", { className: "posts__cell" }, post.title),
                    react.createElement("td", { className: "posts__cell" }, post.body)));
            }),
            emptyRows
                ? emptyRows.map(function (post, i) {
                    return (react.createElement("tr", { key: i, className: "posts__row" },
                        react.createElement("td", { className: "posts__cell" }),
                        react.createElement("td", { className: "posts__cell" }),
                        react.createElement("td", { className: "posts__cell" })));
                })
                : null)));
...
;// CONCATENATED MODULE: ./src/store/actions/actionAPI.ts
...
var GET_POSTS_URL = "https://jsonplaceholder.typicode.com/posts";
    ...
    return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, lib_axios.get(GET_POSTS_URL)];
                case 1:
                    response = _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
var useAppSelector = (/* unused pure expression or super */ null && (useSelector));
...
var Table = function () {
    var status = useSelector_useSelector(function (state) { return state.state.appStatus; });
    var dispatch = useAppDispatch();
    (0,react.useEffect)(function () {
        dispatch(getPosts());
    }, []);
    return (react.createElement("div", { className: "table" },
        status === AppStatus.READY ? (react.createElement(react.Fragment, null,
            react.createElement("div", { className: "table__search" },
                react.createElement(header_Search, null)),
            react.createElement("div", { className: "table__post" },
                react.createElement(posts_Posts, null)),
            react.createElement("div", { className: "table__pagination" },
                react.createElement(pagination_Pagination, null)))) : null,
        status === AppStatus.LOADING ? (react.createElement("p", { className: "table__loading-message" }, "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...")) : null,
        status === AppStatus.ERROR ? (react.createElement("p", { className: "table__error-message" }, "\u041F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430")) : null));
};
...
var Main = function () {
    return (react.createElement(react.Fragment, null,
        react.createElement(table_Table, null)));
};
/* harmony default export */ const Main_Main = (Main);

;// CONCATENATED MODULE: ./src/utils/consts.ts
var MAIN_ROUTE = "/posts/:page";
...
;// CONCATENATED MODULE: ./src/routes/AppRouter.tsx



var AppRouter = function () {
    return (react.createElement(Routes, null,
        publicRoutes.map(function (_a) {
            var path = _a.path, Component = _a.Component;
            return (react.createElement(Route, { key: path, path: path, element: react.createElement(Component, null) }));
        }),
        react.createElement(Route, { path: "/", element: react.createElement(Navigate, { to: "/posts/1" }) })));
};
/* harmony default export */ const routes_AppRouter = (AppRouter);
...
var App = function () {
    return (react.createElement(BrowserRouter, null,
        react.createElement(routes_AppRouter, null)));
};
...
;// CONCATENATED MODULE: ./src/store/reducers/dataReducer.ts
...
var dataReducer = function (state, action) {
    ...
    switch (action.type) {
        ...
        case ActionType.UPDATE_SEARCHED_POSTS:
            return __assign(__assign({}, state), { searchedPosts: action.payload });
        default:
            return state;
    }
};

;// CONCATENATED MODULE: ./src/store/reducers/stateReducer.ts
var stateReducer_assign = (undefined && undefined.__assign) || function () {
    stateReducer_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return stateReducer_assign.apply(this, arguments);
};


var stateReducer_initialState = {
    appStatus: AppStatus.LOADING,
};
var stateReducer = function (state, action) {
    if (state === void 0) { state = stateReducer_initialState; }
    switch (action.type) {
        case ActionType.CHANGE_APP_STATUS:
            return stateReducer_assign(stateReducer_assign({}, state), { appStatus: action.payload });
        default:
            return state;
    }
};

;// CONCATENATED MODULE: ./src/store/reducers/viewReducer.ts
var viewReducer_assign = (undefined && undefined.__assign) || function () {
    viewReducer_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return viewReducer_assign.apply(this, arguments);
};

var viewReducer_initialState = {
    pagesCount: null,
};
var viewReducer = function (state, action) {
    if (state === void 0) { state = viewReducer_initialState; }
    switch (action.type) {
        case ActionType.UPDATE_PAGES_COUNT:
            return viewReducer_assign(viewReducer_assign({}, state), { pagesCount: action.payload });
        default:
            return state;
    }
};
...
root.render(react.createElement(components_Provider, { store: src_store },
